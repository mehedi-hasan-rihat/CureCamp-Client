...
export default function SignUp() {
    ...
    return (
        <div className=" min-h-[calc(100vh-57px)] flex items-center justify-center bg-[#F4F9FF]">
            <section className="p-4 mx-auto max-w-7xl">
                <div className="lg:grid lg:min-h-[500px] lg:grid-cols-12">
                    <section className="relative flex items-end bg-gray-900 h-52 lg:col-span-5 lg:h-full xl:col-span-6">
                        <img
                            alt=""
                            src="https://images.unsplash.com/photo-1617195737496-bc30194e3a19?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
                            className="absolute inset-0 object-cover w-full h-full rounded-md opacity-80"
                        />
                        ...
                        <div className="hidden lg:relative lg:block lg:p-12">
                            ...
                            <p className="mt-4 leading-relaxed text-white/90">
                                Start your adventure—one step closer to your
                                goals
                            </p>
                        </div>
                    </section>
